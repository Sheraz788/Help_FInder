package com.example.helpfinders.provider.ui.settings
...
class UpdateProfileFragment : Fragment() {
    ...
    private fun setProfileData(){
        ...
        if(currentUser != null) {
            ...
            if (currentUser.perHourCharges != null){
                txt_per_hour.setText(currentUser.perHourCharges!!.toString())
            }
    ...
    fun updateProfileData(){
        ...
        val perHourCharge = txt_per_hour.text.toString()
