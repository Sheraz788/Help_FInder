package com.example.helpfinders.customer.ui.notifications
...
import com.example.helpfinders.customer.ui.notifications.adapters.NotificationsAdapter
...
class NotificationsFragment : Fragment() {
    ...
    fun updateNotificationsList(){
        ...
        notificationsHashMap.values.forEach {notification ->
                ...
                // update ui
                var userRef = FirebaseDatabase.getInstance().getReference("users/${fromId}")
